    ...
    public partial class pokemonForm : Form
    {
        ...
        void fill_listbox()
        {
            try
            {
                ...
                string query = "show tables from pokemon;";
                ...
                while (myReader.Read())
                {
                    string tableName = myReader.GetString("Tables_in_pokemon");
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from pokemon." + txtFindSet.Text + " where cardNumber='" + listBox1.Text + "';";
        ...
        private void addSetClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "create table pokemon." + txtAddSet.Text + " (" +
        ...
        private void findSetClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from pokemon." + txtFindSet.Text;
                //MessageBox.Show(query);
        ...
        private void updateClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "update pokemon." + txtFindSet.Text + " set cardNumber='"
        ...
        private void insertClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "insert into pokemon." + txtFindSet.Text + " (cardNumber, cardName, setCard, extras) values ('"
                    + this.txtCardNumber.Text + "', '"
