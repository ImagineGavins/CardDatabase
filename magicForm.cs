    ...
    public partial class magicForm : Form
    {
        ...
        void fill_listbox()
        {
            try
            {
                ...
                string query = "show tables from magic;";
                ...
                while (myReader.Read())
                {
                    string tableName = myReader.GetString("Tables_in_magic");
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from magic." + txtFindSet.Text + " where cardNumber='" + listBox1.Text + "';";
        ...
        private void addSetClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "create table magic." + txtAddSet.Text + " (" +
        ...
        private void findSetClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "select * from magic." + txtFindSet.Text;
                //MessageBox.Show(query);
        ...
        private void updateClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "update magic." + txtFindSet.Text + " set cardNumber='"
        ...
        private void insertClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "insert into magic." + txtFindSet.Text + " (cardNumber, cardName, setCard, extras) values ('"
                    + this.txtCardNumber.Text + "', '"
